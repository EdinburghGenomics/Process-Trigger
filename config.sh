...
EXECROOT=$HOME/bin  # Path to executables. Set up symbolic links to the Process Trigger bash scripts
WORKFLOWEXE=$EXECROOT/ptworkflow
...
PYTHON=$HOME/envs/23_06_15/bin/python
